...
(setq user-full-name "Divyansh Kamboj"
      user-mail-address "kambojdivyansh2000@gmail.com")
...
(server-start)
(add-to-list 'load-path "~/git/org")
(require 'org-protocol)


(setenv "PATH" (concat (getenv "PATH") ":/home/weirdwiz/go/bin"))
...
;; - `after!' for running code after a package has laded
...
(add-hook 'go-mode-hook #'locally-defer-font-lock)
